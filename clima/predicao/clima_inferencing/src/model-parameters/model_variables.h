...
const char* ei_classifier_inferencing_categories[] = { "No_Rain", "Rain" };

uint8_t ei_dsp_config_14_axes[] = { 0, 1, 2, 3 };
const uint32_t ei_dsp_config_14_axes_size = 4;
ei_dsp_config_flatten_t ei_dsp_config_14 = {
    14, // uint32_t blockId
...
const ei_impulse_t impulse_537167_0 = {
    .project_id = 537167,
    .project_owner = "GRAZIELE RODRIGUES",
    .project_name = "clima",
    .impulse_id = 1,
    ...
    .input_frames = 0,
    .interval_ms = 172800,
    .frequency = 0.005787037037037037,
    ...
    .fusion_string = "temperatura + sensacao + umidade + pressao",
    .slice_size = (4/4),
...
ei_impulse_handle_t impulse_handle_537167_0 = ei_impulse_handle_t( &impulse_537167_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_537167_0;
